...
DAEMONS=(cfo-proactive cfo-automation-engine cfo-credentials-sync cfo-supabase-sync cfo-evolution-sync cfo-telegram-sync cfo-mcp-warmer cfo-metrics-publisher)
