#!/usr/bin/env python3
"""
MCP server para PipeRun — 8 tools.
...
async def list_tools() -> list[types.Tool]:
    return [
        types.Tool(
            name='piperun_deals_listar',
            description='Lista deals/oportunidades do PipeRun (paginado)',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='piperun_deal_mover',
            description='Move deal para outra etapa/stage no PipeRun',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='piperun_deal_atualizar',
            description='Atualiza valor e/ou data de fechamento do deal no PipeRun',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='piperun_deal_criar',
            description='Cria novo deal/oportunidade no PipeRun',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='piperun_deal_nota',
            description='Adiciona nota/comentario a um deal no PipeRun',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='piperun_deal_ganho',
            description='Marca deal como ganho/won no PipeRun',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='piperun_deal_perdido',
            description='Marca deal como perdido/lost no PipeRun',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='piperun_empresa',
            description='Informacoes da empresa conectada ao PipeRun',
