#!/usr/bin/env python3
"""
MCP server para RD Station — 8 tools.
...
async def list_tools() -> list[types.Tool]:
    return [
        types.Tool(
            name='rd_station_deals_listar',
            description='Lista deals/oportunidades do RD Station (paginado)',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='rd_station_deal_mover',
            description='Move deal para outra etapa/stage no RD Station',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='rd_station_deal_atualizar',
            description='Atualiza valor e/ou data de fechamento do deal no RD Station',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='rd_station_deal_criar',
            description='Cria novo deal/oportunidade no RD Station',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='rd_station_deal_nota',
            description='Adiciona nota/comentario a um deal no RD Station',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='rd_station_deal_ganho',
            description='Marca deal como ganho/won no RD Station',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='rd_station_deal_perdido',
            description='Marca deal como perdido/lost no RD Station',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='rd_station_empresa',
            description='Informacoes da empresa conectada ao RD Station',
