#!/usr/bin/env python3
"""
MCP server para Conta Azul — 9 tools.
...
async def list_tools() -> list[types.Tool]:
    return [
        types.Tool(
            name='contaazul_saldo',
            description='Saldo financeiro atual da empresa no Conta Azul',
            inputSchema={'type': 'object', 'properties': {}, 'required': []}
        ),
        types.Tool(
            name='contaazul_titulos_pagar',
            description='Lista contas a pagar do Conta Azul (paginado)',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='contaazul_titulos_receber',
            description='Lista contas a receber do Conta Azul (paginado)',
            inputSchema={
                'type': 'object',
                'properties': {
                    'from_date': {'type': 'string', 'description': 'Data inicio (YYYY-MM-DD)'},
        ...
        types.Tool(
            name='contaazul_pagar_titulo',
            description='Marca titulo a pagar como pago no Conta Azul',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='contaazul_receber_titulo',
            description='Marca titulo a receber como recebido no Conta Azul',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='contaazul_criar_pagar',
            description='Cria novo titulo a pagar no Conta Azul',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='contaazul_criar_receber',
            description='Cria novo titulo a receber no Conta Azul',
            inputSchema={
                'type': 'object',
                'properties': {
                    'amount': {'type': 'number', 'description': 'Valor em BRL'},
        ...
        types.Tool(
            name='contaazul_cancelar_pagar',
            description='Cancela/exclui titulo a pagar no Conta Azul',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='contaazul_empresa',
            description='Informacoes da empresa conectada ao Conta Azul',
            inputSchema={'type': 'object', 'properties': {}, 'required': []}
        ),
    ]
