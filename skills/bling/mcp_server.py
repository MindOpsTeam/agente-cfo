...
async def list_tools() -> list[types.Tool]:
    return [
        types.Tool(
            name='bling_saldo',
            description='Saldo financeiro atual da empresa no Bling',
            inputSchema={'type': 'object', 'properties': {}, 'required': []}
        ),
        types.Tool(
            name='bling_titulos_pagar',
            description='Lista contas a pagar do Bling (paginado)',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='bling_titulos_receber',
            description='Lista contas a receber do Bling (paginado)',
            inputSchema={
                'type': 'object',
                'properties': {
                    'from_date': {'type': 'string', 'description': 'Data inicio (YYYY-MM-DD)'},
        ...
        types.Tool(
            name='bling_pagar_titulo',
            description='Marca titulo a pagar como pago no Bling',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='bling_receber_titulo',
            description='Marca titulo a receber como recebido no Bling',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='bling_criar_pagar',
            description='Cria novo titulo a pagar no Bling',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='bling_criar_receber',
            description='Cria novo titulo a receber no Bling',
            inputSchema={
                'type': 'object',
                'properties': {
                    'amount': {'type': 'number', 'description': 'Valor em BRL'},
        ...
        types.Tool(
            name='bling_empresa',
            description='Informacoes da empresa conectada ao Bling',
            inputSchema={'type': 'object', 'properties': {}, 'required': []}
        ),
    ]
