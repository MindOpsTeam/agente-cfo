#!/usr/bin/env python3
"""
MCP server para HubSpot — 8 tools.
...
async def list_tools() -> list[types.Tool]:
    return [
        types.Tool(
            name='hubspot_deals_listar',
            description='Lista deals/oportunidades do HubSpot (paginado)',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='hubspot_deal_mover',
            description='Move deal para outra etapa/stage no HubSpot',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='hubspot_deal_atualizar',
            description='Atualiza valor e/ou data de fechamento do deal no HubSpot',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='hubspot_deal_criar',
            description='Cria novo deal/oportunidade no HubSpot',
            inputSchema={
                'type': 'object',
                'properties': {
        ...
        types.Tool(
            name='hubspot_deal_nota',
            description='Adiciona nota/comentario a um deal no HubSpot',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='hubspot_deal_ganho',
            description='Marca deal como ganho/won no HubSpot',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='hubspot_deal_perdido',
            description='Marca deal como perdido/lost no HubSpot',
            inputSchema={
                'type': 'object',
                'properties': {
                    'id': {'type': 'string', 'description': 'ID do deal'},
        ...
        types.Tool(
            name='hubspot_empresa',
            description='Informacoes da empresa conectada ao HubSpot',
